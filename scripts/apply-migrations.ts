...
async function main() {
  ...
  for (const file of files) {
    ...
    const isNewMigration = file.startsWith('0003') || file.startsWith('0004') || file.startsWith('0011') || file.startsWith('0012') || file.startsWith('0013') || file.startsWith('0014') || file.startsWith('0015');
    if (!isNewMigration) {

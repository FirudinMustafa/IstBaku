// TR 81 il + AZ tüm şehir/rayon veri seti.
// Country artık string (dinamik); locations.ts ülke kodu indeksli Record.
...
// ============================================================
// TÜRKİYE — 81 İL, TÜM İLÇELER
// ============================================================

const TR_CITIES: CityNode[] = [
...
// ============================================================
// AZERBAYCAN — TÜM ŞEHİRLER VE RAYONLAR
// ============================================================

const AZ_CITIES: CityNode[] = [
  // Respublika tabeli şəhərlər
  { name: 'Bakı', districts: ['Binəqədi', 'Xəzər', 'Xətai', 'Qaradağ', 'Nərimanov', 'Nəsimi', 'Nizami', 'Pirallahı', 'Sabunçu', 'Səbail', 'Suraxanı', 'Yasamal'] },
  { name: 'Gəncə', districts: ['Kəpəz', 'Nizami'] },
  { name: 'Sumqayıt', districts: ['Sumqayıt'] },
  { name: 'Mingəçevir', districts: ['Mingəçevir'] },
  { name: 'Şirvan', districts: ['Şirvan'] },
  { name: 'Naftalan', districts: ['Naftalan'] },
  { name: 'Lənkəran', districts: ['Lənkəran'] },
  { name: 'Şəki', districts: ['Şəki'] },
  { name: 'Yevlax', districts: ['Yevlax'] },
  // Abşeron iqtisadi rayonu
  { name: 'Abşeron', districts: ['Xırdalan', 'Saray', 'Ceyranbatan', 'Masazır', 'Hökməli', 'Digah'] },
  // Aran iqtisadi rayonu
  { name: 'Ağcabədi', districts: ['Ağcabədi'] },
  { name: 'Ağdaş', districts: ['Ağdaş'] },
  { name: 'Bərdə', districts: ['Bərdə'] },
  { name: 'Beyləqan', districts: ['Beyləqan'] },
  { name: 'Biləsuvar', districts: ['Biləsuvar'] },
  { name: 'Göyçay', districts: ['Göyçay'] },
  { name: 'Hacıqabul', districts: ['Hacıqabul'] },
  { name: 'İmişli', districts: ['İmişli'] },
  { name: 'Kürdəmir', districts: ['Kürdəmir'] },
  { name: 'Neftçala', districts: ['Neftçala'] },
  { name: 'Saatlı', districts: ['Saatlı'] },
  { name: 'Sabirabad', districts: ['Sabirabad'] },
  { name: 'Salyan', districts: ['Salyan'] },
  { name: 'Ucar', districts: ['Ucar'] },
  { name: 'Zərdab', districts: ['Zərdab'] },
  // Dağlıq Şirvan
  { name: 'Ağsu', districts: ['Ağsu'] },
  { name: 'İsmayıllı', districts: ['İsmayıllı'] },
  { name: 'Şamaxı', districts: ['Şamaxı'] },
  // Gəncə-Qazax
  { name: 'Ağstafa', districts: ['Ağstafa'] },
  { name: 'Daşkəsən', districts: ['Daşkəsən'] },
  { name: 'Gədəbəy', districts: ['Gədəbəy'] },
  { name: 'Goranboy', districts: ['Goranboy'] },
  { name: 'Göygöl', districts: ['Göygöl'] },
  { name: 'Qazax', districts: ['Qazax'] },
  { name: 'Samux', districts: ['Samux'] },
  { name: 'Şəmkir', districts: ['Şəmkir'] },
  { name: 'Tovuz', districts: ['Tovuz'] },
  // Quba-Xaçmaz
  { name: 'Quba', districts: ['Quba'] },
  { name: 'Qusar', districts: ['Qusar'] },
  { name: 'Xaçmaz', districts: ['Xaçmaz'] },
  { name: 'Şabran', districts: ['Şabran'] },
  { name: 'Siyəzən', districts: ['Siyəzən'] },
  // Lənkəran iqtisadi rayonu
  { name: 'Astara', districts: ['Astara'] },
  { name: 'Cəlilabad', districts: ['Cəlilabad'] },
  { name: 'Lerik', districts: ['Lerik'] },
  { name: 'Masallı', districts: ['Masallı'] },
  { name: 'Yardımlı', districts: ['Yardımlı'] },
  // Şəki-Zaqatala
  { name: 'Balakən', districts: ['Balakən'] },
  { name: 'Qax', districts: ['Qax'] },
  { name: 'Qəbələ', districts: ['Qəbələ'] },
  { name: 'Oğuz', districts: ['Oğuz'] },
  { name: 'Zaqatala', districts: ['Zaqatala'] },
  // Yuxarı Qarabağ
  { name: 'Ağdam', districts: ['Ağdam'] },
  { name: 'Füzuli', districts: ['Füzuli'] },
  { name: 'Xocalı', districts: ['Xocalı'] },
  { name: 'Xocavənd', districts: ['Xocavənd'] },
  { name: 'Şuşa', districts: ['Şuşa'] },
  { name: 'Tərtər', districts: ['Tərtər'] },
  // Kəlbəcər-Laçın
  { name: 'Kəlbəcər', districts: ['Kəlbəcər'] },
  { name: 'Laçın', districts: ['Laçın'] },
  { name: 'Zəngilan', districts: ['Zəngilan'] },
  { name: 'Qubadlı', districts: ['Qubadlı'] },
  { name: 'Cəbrayıl', districts: ['Cəbrayıl'] },
  // Digər
  { name: 'Xızı', districts: ['Xızı'] },
  // Naxçıvan Muxtar Respublikası
  { name: 'Naxçıvan', districts: ['Naxçıvan şəhəri', 'Babək', 'Culfa', 'Kəngərli', 'Ordubad', 'Sədərək', 'Şahbuz', 'Şərur'] },
];
...
const CITIES_BY_COUNTRY: Record<string, CityNode[]> = {
  TR: TR_CITIES,
  AZ: AZ_CITIES,
};

export { TR_CITIES, AZ_CITIES };

export function citiesOf(country: string): CityNode[] {
  return CITIES_BY_COUNTRY[country] ?? [];
}

export function districtsOf(country: string, cityName: string): string[] {
  const city = citiesOf(country).find((c) => c.name === cityName);
  return city ? city.districts : [];
}

export function defaultCity(country: string): string {
  return citiesOf(country)[0]?.name ?? '';
}

export function defaultDistrict(country: string, city: string): string {
  return districtsOf(country, city)[0] ?? '';
}

...
export const DEFAULT_GUIDES: CountryGuide[] = [
  { iso: 'TR', name: 'Türkiye', flag: '🇹🇷', description: 'Türk vatandaşı olmayanlar için Türkiye\'de ev alım rehberi: vergi no, tapu işlemleri, vatandaşlık avantajı, döviz girişi.', pdfUrl: '/api/country-guide?iso=TR', updatedAt: '2026-04-12', pages: 24, language: 'tr' },
  { iso: 'AZ', name: 'Azerbaycan', flag: '🇦🇿', description: 'Yabancılar için Azerbaycan\'da ev alım rehberi: VOEN, notar, ASAN Xidmət, oturum izni.', pdfUrl: '/api/country-guide?iso=AZ', updatedAt: '2026-03-28', pages: 22, language: 'az' },
  { iso: 'RU', name: 'Россия', flag: '🇷🇺', description: 'Rus vatandaşlarının Türkiye ve Azerbaycan\'da ev alımı için resmi prosedürler ve döviz kuralları.', pdfUrl: '/api/country-guide?iso=RU', updatedAt: '2026-02-10', pages: 18, language: 'en' },
